...
import com.github.spitsinstafichuk.vkazam.model.observers.IRecognizeStatusObserver;
...
public class RecognizeHistoryService extends Service
        implements IRecognizeStatusObserver, ServiceConnection {
    ...
    public void onCreate() {
        ...
        bindService(new Intent(RecognizeHistoryService.this, RecognizeService.class), this,
    ...
    public synchronized int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (PreferenceManager.getDefaultSharedPreferences(this)
                .getBoolean("settingsAutoRecognize", false) && !isStarted) {
            isStarted = true;
            Log.i(TAG, "recognizing");
            RecognizeServiceConnection.getModel().getRecognizeListManager()
                    .addRecognizeStatusObserver(this);
    ...
    public void onDestroy() {
        Log.i(TAG, "onDestroy");
        RecognizeServiceConnection.getModel().getRecognizeListManager()
                .removeRecognizeStatusObserver(this);
        unbindService(this);
    ...
    public void onServiceConnected(ComponentName className, IBinder service) {
        ...
        RecognizeServiceConnection
                .setModel(((RecognizeService.RecognizeBinder) service).getService().getModel());
    }
