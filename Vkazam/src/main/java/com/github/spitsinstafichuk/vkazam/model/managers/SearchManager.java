...
public class SearchManager {
    ...
    public void search(String artist, String album, String title, SearchListener listener) {
        ...
        GNOperations.searchByText(new GNSearchResultReadyImplementation(listener), config, artist,
                album, title);
    }
    ...
    public void search(String trackId, SearchListener listener) {
        ...
        GNOperations
                .fetchByTrackId(new GNSearchResultReadyImplementation(listener), config, trackId);
    }
}