...
public class SongData {
	...
	public void findPPAudio() throws MalformedURLException, IOException, JSONException, com.github.spitsinstafichuk.vkazam.model.pleer.api.KException, SongNotFoundException {
		List<com.github.spitsinstafichuk.vkazam.model.pleer.api.Audio> audioList = com.github.spitsinstafichuk.vkazam.model.pleer.api.Api.searchAudio(getArtist() + " " + getTitle(), 1, 1);
		if (audioList.isEmpty()) {
            if ((getAlbumArtist() != null) &&
                (!getAlbumArtist().equals(getArtist()))) {
                audioList = com.github.spitsinstafichuk.vkazam.model.pleer.api.Api.searchAudio(getAlbumArtist() + " " + getTitle(), 1, 1);
            }
            if (audioList.isEmpty()) {
                throw new SongNotFoundException();
            }
