...
public class MicrophoneRecordingTimerService extends MicrophoneRecordingService {
	...
	/**
	 * Value that tells about maximum progress of timer delay Because of round
	 * progress implementation (as default), progress increments until 360 value
	 * will be reached
	 */
	...
	public void onResultStatus(SongData data) {
		...
		long period = prefs.getInt("settingsTimerDelay",
	...
	/**
	 * Provides updating of progress wheel when preparing next recording
	 */
