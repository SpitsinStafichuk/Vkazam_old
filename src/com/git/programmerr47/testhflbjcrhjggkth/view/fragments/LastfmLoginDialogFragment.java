...
public class LastfmLoginDialogFragment extends DialogFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		lastfmLoginRequestProgress = (ProgressBar) v
				.findViewById(R.id.lastLoginRequestProgress);
		statusLayout = (LinearLayout) v
				.findViewById(R.id.lastfmLoginStatusLayout);
		...
		loginButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				System.out.println("LastFM Login: "
						+ login.getText().toString());
				System.out.println("LastFM Password: "
				...
				new Thread() {
					...
					public void run() {
						...
						try {
							MicroScrobblerModel.getInstance().setLastfmAccount(
									login.getText().toString(),
									password.getText().toString());
