...
public class SongDAO extends AbstractDAO implements ISongDAOObservable {
	...
	public synchronized long insert(Data data) {
		...
		values.put(DBConstants.MUSIC_HISTORY_CONTRIBUTOR_IMAGE_URL, songData.getContributorImageUrl());
		...
		values.put(DBConstants.MUSIC_HISTORY_ALBUM_RELEASE_YEAR, songData.getAlbumReleaseYear());
